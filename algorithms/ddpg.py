...
class DDPGAgent:
    """Discrete-action DDPG-style baseline for CartPole experiments."""
    ...
    def __init__(
        ...
        self.ddpg_use_target_critic = bool(ddpg_use_target_critic)
    ...
    def update(self, data):
        ...
        with torch.no_grad():
            target_net = self.target_critic if self.ddpg_use_target_critic else self.critic
        ...
        if self.ddpg_use_target_critic:
            self.soft_update()
    ...
    def train(self, env):
        ...
        return {
            ...
            "ablation/ddpg_use_target_critic": self.ddpg_use_target_critic,
            **metrics,
        }
