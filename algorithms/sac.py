...
class SACAgent:
    def __init__(
        ...
        self.sac_auto_alpha = bool(sac_auto_alpha)
    ...
    def update(self, data):
        ...
        return actor_loss.item(), critic1_loss.item(), critic2_loss.item(), self.alpha.item(), alpha_loss_value
    ...
    def train(self, env):
        ...
        while not done:
            ...
            if len(self.replay_buffer) >= self.minimal_size:
                actor_loss, critic1_loss, critic2_loss, alpha, alpha_loss = self.update(self.replay_buffer.sample(self.batch_size))
                metrics = {
        ...
        return {
            ...
            "ablation/sac_auto_alpha": self.sac_auto_alpha,
            **metrics,
        }
