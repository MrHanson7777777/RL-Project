...
def parse_args():
    ...
    parser.add_argument("--actor-lr", type=float, default=config.get("actor_lr", config.get("lr", 1e-3)))
    parser.add_argument("--critic-lr", type=float, default=config.get("critic_lr", config.get("lr", 1e-3)))
